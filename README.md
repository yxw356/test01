...
<p align="center">
  <img src="./img/dashboard.png" alt="龙汇QA前端界面" width="100%" />
</p>
...
| [docs/功能增强变更说明.md](./docs/功能增强变更说明.md) | **v1.3 对话落库、索引状态、RAG/上传/管理端修复** |
| [docs/需求文档.md](./docs/需求文档.md) | 功能需求、验收标准与排障索引 |
| [docs/知识库分域与边界定义.md](./docs/知识库分域与边界定义.md) | **业务知识库划分**（制度/项目/售前/运维）、权限与试点节奏 |
| [docs/eval/README.md](./docs/eval/README.md) | 分库 RAG 评测集 JSONL 规范 |

## 知识治理（试点）

不要一开始做「公司所有知识都能问」。建议按业务域拆为制度流程、项目、售前、客服运维等库，用 **组织标签 `KB_*`** 配置权限与上传归属；问答提示词与评测集按库治理。详见 [知识库分域与边界定义.md](./docs/知识库分域与边界定义.md)。
...
| 文档解析 | Tika 解析 PDF / Word / TXT；表格 **.xlsx / .xls / .csv** 专用结构化解析 |
